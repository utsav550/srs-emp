...
<body class="bg-gradient-primary">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="includes/forgot.inc.php"  method="post">
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter OTP" name="id" value="<?php  echo $idems; ?> " hidden>
    ...
    if(isset($_GET["error"])){
      ...
      if($_GET["error"] == "notmatch"){
        echo '<div class="alert alert-danger" role="alert">
        Enter Same Password for both Fields.
       </div>';
      }
      if($_GET["error"] == "ver"){
    ...
    ?>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block" name="changepass">Change Password</button>
